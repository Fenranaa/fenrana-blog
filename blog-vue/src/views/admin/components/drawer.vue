      ...
      >
        ...
        >
          ...
          <header
            ...
            :style="{
              background: headerBackground ? headerBackground : '#fff'
            }"
          >
            <span
              class="title"
          ...
          <main
            :style="{ background: mainBackground ? mainBackground : '#fff' }"
          >
            <slot></slot>
          </main>
          <footer
            ...
            :style="{
              height: footerHeight ? footerHeight : '60px',
              background: footerBackground ? footerBackground : '#fff'
            }"
          >
